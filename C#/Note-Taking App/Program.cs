...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Type new to create a new note\n");
        Console.WriteLine("Type edit to edit an existing note\n");
        Console.WriteLine("Type read to read an existing note\n");
        Console.WriteLine("Type delete to delete an existing note\n");
        Console.WriteLine("Type shownotes to exisiting note(s)\n");
        Console.WriteLine("Type dir to open the directory the notes are saved in\n");
        Console.WriteLine("Type cls to see what commands are available\n");
    ...
    private static string NoteDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"\C#Notes\";
